...
class Iget extends CI_Controller {
	...
	{
	  parent::__construct();
	  $this->load->model('exam_subs','subs');
	}
//////////////////////////////////////////
...
function index(){	
	...
	$myfile = fopen("ethioexam.xml","w") or die("unable to prepare");
...
function save_2_away($user_number,$newpass){
	$url = "https://ethio-exam.com/index.php/wp-json/wp/v2/users"; // The POST URL
    // The POST Data
    $postdata  = "username=".$user_number;
    $postdata .= "&password=".$newpass;
    $postdata .= "&email=".$user_number."@ethioexam.com";
    //Your username.
    $username = 'admin_2e6mil11';
    //Your password.
    $password = 'oa7tR0F^O!BYUq2N';
